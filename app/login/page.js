...
const Login = () => {
    ...
    return (
        <div className=' text-white container mx-auto py-14 '>
            ...
            <div class="flex flex-col gap-2    justify-center  items-center p-20">


                <button 
                onClick={() => signIn('google')}
                    class="flex items-center w-64 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <div className='flex flex-col justify-start items-start  '>
                    <span className='text-blue-300 underline w-64 hover:cursor-pointer hover:text-blue-700  font-bold text-xs'> Read terms and Condition Accept privacy policy</span>
                    <span className='text-red-400 underline hover:cursor-pointer hover:text-red-700  font-bold text-xs'>forgot password ?</span>
                </div>
            </div>
        </div>
    )
